...
// CLIKit
#define COCOAPODS_POD_AVAILABLE_CLIKit
#define COCOAPODS_VERSION_MAJOR_CLIKit 0
#define COCOAPODS_VERSION_MINOR_CLIKit 1
#define COCOAPODS_VERSION_PATCH_CLIKit 0
